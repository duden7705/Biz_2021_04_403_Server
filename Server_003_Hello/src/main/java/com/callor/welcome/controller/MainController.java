 ...
 * 
 * Request를 제일 먼저 받은 main Class 이다
...
// 그런데 Network와 관련된 코드는 너무 복잡하고 다양한 기술을
...
// 1. 현재 컴퓨터에서 시작한 Tomcat이 응답을 수신한다
//		http://localhost:8080 : Tomcat을 호출하는 Request
// 2. Tomcat 이후에 보내지는 문자열을 분석하기 시작한다
//		/welcome 부분을 분석하여
//		Rnu As Server로 시작된 프로젝트 중에서
//		root Context가 welcome인 프로젝트를 찾는다
// 3. 프로젝트가 있으면 /home 문자열을 다시 분석하여
//		프로젝트내의 클래스 중에서
// 		@WebServlet("/home") Annotation으로 설정된
//		클래스를 찾는다
